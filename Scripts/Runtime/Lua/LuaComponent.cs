    ...
    public class LuaComponent : GameFrameworkComponent
    {
        ...
        public void Initialization()
        {
            ...
            if (m_BaseComponent.EditorResourceMode)
            {
                ...
                luaManager.AddSearchPath(CustomSettings.baseLuaDir);

//                 string scriptPath = Application.dataPath + "ProjectResources/Lua";
//                 Debug.LogWarning("scriptPath = " + scriptPath);
                luaManager.AddSearchPath(CustomSettings.luaDir);


            }
            else
            {
                bool IsDebug = true;//m_BaseComponent.Channel.Contains("_debug");
