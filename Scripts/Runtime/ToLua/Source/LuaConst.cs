...
{
    public static string luaDir = Application.dataPath + "/ProjectRes/Lua";
    public static string toluaDir = Application.dataPath + "/GameFramework/Scripts/Runtime/ToLua/Lua";
