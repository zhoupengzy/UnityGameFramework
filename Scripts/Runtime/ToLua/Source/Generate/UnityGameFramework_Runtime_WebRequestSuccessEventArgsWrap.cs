...
public class UnityGameFramework_Runtime_WebRequestSuccessEventArgsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", _CreateUnityGameFramework_Runtime_WebRequestSuccessEventArgs);
	...
	static int Create(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			GameFramework.WebRequest.WebRequestSuccessEventArgs arg0 = (GameFramework.WebRequest.WebRequestSuccessEventArgs)ToLua.CheckObject(L, 1, typeof(GameFramework.WebRequest.WebRequestSuccessEventArgs));
