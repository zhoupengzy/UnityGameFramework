...
public class UnityGameFramework_Runtime_WebRequestFailureEventArgsWrap
{
	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			GameFramework.WebRequest.WebRequestFailureEventArgs arg0 = (GameFramework.WebRequest.WebRequestFailureEventArgs)ToLua.CheckObject(L, 1, typeof(GameFramework.WebRequest.WebRequestFailureEventArgs));
