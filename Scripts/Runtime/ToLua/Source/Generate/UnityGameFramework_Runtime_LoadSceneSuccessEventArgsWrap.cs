...
public class UnityGameFramework_Runtime_LoadSceneSuccessEventArgsWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("New", _CreateUnityGameFramework_Runtime_LoadSceneSuccessEventArgs);
	...
	static int Create(IntPtr L)
	{
		try
		{
			...
			GameFramework.Scene.LoadSceneSuccessEventArgs arg0 = (GameFramework.Scene.LoadSceneSuccessEventArgs)ToLua.CheckObject(L, 1, typeof(GameFramework.Scene.LoadSceneSuccessEventArgs));
	...
	static int Clear(IntPtr L)
	{
		...
		{
			ToLua.CheckArgsCount(L, 1);
			UnityGameFramework.Runtime.LoadSceneSuccessEventArgs obj = (UnityGameFramework.Runtime.LoadSceneSuccessEventArgs)ToLua.CheckObject(L, 1, typeof(UnityGameFramework.Runtime.LoadSceneSuccessEventArgs));
			obj.Clear();
			return 0;
		}
		catch (Exception e)
