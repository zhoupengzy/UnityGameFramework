...
public class UnityGameFramework_Runtime_BaseComponentWrap
{
	...
	static int get_EditorResourceMode(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index EditorResourceMode on a nil value");
		}
	}
	...
	static int get_EditorLanguage(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index EditorLanguage on a nil value");
		}
	}
	...
	static int get_EditorResourceHelper(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index EditorResourceHelper on a nil value");
		}
	}
	...
	static int get_IsGamePaused(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index IsGamePaused on a nil value");
		}
	}
	...
	static int get_IsNormalGameSpeed(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index IsNormalGameSpeed on a nil value");
		}
	}
	...
	static int get_RunInBackground(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index RunInBackground on a nil value");
		}
	}
	...
	static int get_NeverSleep(IntPtr L)
	{
		...
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index NeverSleep on a nil value");
		}
	}
	...
	static int set_EditorResourceHelper(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			UnityGameFramework.Runtime.BaseComponent obj = (UnityGameFramework.Runtime.BaseComponent)o;
			GameFramework.Resource.IResourceManager arg0 = (GameFramework.Resource.IResourceManager)ToLua.CheckObject<GameFramework.Resource.IResourceManager>(L, 2);
