...
public class UnityGameFramework_Runtime_ProcedureComponentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("HasProcedure", HasProcedure);
		L.RegFunction("GetProcedure", GetProcedure);
		L.RegFunction("__eq", op_Equality);
		L.RegFunction("__tostring", ToLua.op_ToString);
		L.RegVar("CurrentProcedure", get_CurrentProcedure, null);
		L.RegVar("CurrentProcedureTime", get_CurrentProcedureTime, null);
		L.EndClass();
	}
	...
	static int HasProcedure(IntPtr L)
	{
		try
		{
			...
			UnityGameFramework.Runtime.ProcedureComponent obj = (UnityGameFramework.Runtime.ProcedureComponent)ToLua.CheckObject(L, 1, typeof(UnityGameFramework.Runtime.ProcedureComponent));
